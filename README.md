...
- `express-session`, `connect-mongo` - required. An earlier version of this template uses `next-session`.
...
- `process.env.SESSION_SECRET` The secret to be used in `express-session`.
